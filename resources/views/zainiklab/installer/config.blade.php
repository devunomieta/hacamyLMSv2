          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="purchase_code" name="purchase_code" value="31200164-dd02-49ea-baef-3865c90acc123" placeholder="31200164-dd02-49ea-baef-3865c90acc123" />
              </div>
            </div>
          </div>
        </div>
